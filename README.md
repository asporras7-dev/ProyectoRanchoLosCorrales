...
- **Procesamiento de Datos en el Cliente (Client-Side Rendering)**: En lugar de saturar el backend generando reportes de Excel, el panel administrativo descarga el crudo JSON y utiliza **SheetJS** para formatear y compilar archivos .xlsx o .csv nativamente en el navegador del usuario moderador o administrador.
